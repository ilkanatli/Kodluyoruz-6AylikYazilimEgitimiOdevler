...
public class OperatorGUI extends JFrame {
    ...
    public OperatorGUI(Operator operator){
        ...
        /*
        Object[] first_row = {"1","İlkan Atlı","ilkan","123","operator"};
        mdl_user_list.addRow(first_row);
        */
        ...
        Object[] col_courseList =  {"ID","Ders Adi","Programlama Dili","Patika","Eğitmen"};
        ...
        btn_user_sh.addActionListener(e -> {
            ...
            String u_name = fld_sh_user_uname.getText();
            String type = cmb_sh_user_type.getSelectedItem().toString();
            String query = User.searchQuery(name,u_name,type);
